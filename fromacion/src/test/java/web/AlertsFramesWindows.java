...
public class AlertsFramesWindows extends Main {
    ...
    public void TC009_Browser_Windows() throws InterruptedException, IOException {  
        ...
        try{
            ...
            File scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
            FileUtils.copyFile(scrFile, new File("C:\\Users\\unai.ovejero.ext\\Documents\\F_QS\\Formacion_QS\\ScrnShts\\TC_009\\Succesful.png"));
            driver.quit();
            //
            System.out.println("|-------------------------------------------------------------------|");
    ...
    public void TC010_Alerts() throws InterruptedException, IOException {
        ...
        try{
            ...
            File scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
            FileUtils.copyFile(scrFile, new File("C:\\Users\\unai.ovejero.ext\\Documents\\F_QS\\Formacion_QS\\ScrnShts\\TC_010\\Succesful.png"));
            driver.quit();
            //
            System.out.println("|-------------------------------------------------------------------|");
    ...
    public void TC011_Frames() throws InterruptedException, IOException {
        ...
        try{
            ...
            File scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
            FileUtils.copyFile(scrFile, new File("C:\\Users\\unai.ovejero.ext\\Documents\\F_QS\\Formacion_QS\\ScrnShts\\TC_011\\Succesful.png"));
            driver.quit();
            //
            System.out.println("|-------------------------------------------------------------------|");
    ...
    public void TC012_Nested_Frames() throws InterruptedException, IOException {
        ...
        try{
            ...
            File scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
            FileUtils.copyFile(scrFile, new File("C:\\Users\\unai.ovejero.ext\\Documents\\F_QS\\Formacion_QS\\ScrnShts\\TC_012\\Succesful.png"));
            driver.quit();
        }
    }
    ...
    public void TC013_Modal_Dialogs() throws InterruptedException, IOException {
        ...
        try{
            ...
            File scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
            FileUtils.copyFile(scrFile, new File("C:\\Users\\unai.ovejero.ext\\Documents\\F_QS\\Formacion_QS\\ScrnShts\\TC_013\\Succesful.png"));
            driver.quit();
        }
    }
}
